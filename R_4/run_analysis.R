...
act_labels <- read.csv("F:/MyGitHub/TestRepository/STPSS/R_4/data/activity_labels.txt", header=FALSE, dec=".",sep=" ")
colnames(act_labels) <- c("n", "activity")

#Reading test,train data
test_lines <- readLines(file("F:/MyGitHub/TestRepository/STPSS/R_4/data/test/X_test.txt",open="r"))
train_lines <- readLines(file("F:/MyGitHub/TestRepository/STPSS/R_4/data/train/X_train.txt",open="r"))
data_lines<-c(test_lines,train_lines)

#Reading activity numbers
test_act_nbs <- readLines(file("F:/MyGitHub/TestRepository/STPSS/R_4/data/test/y_test.txt",open="r"))
train_act_nbs <- readLines(file("F:/MyGitHub/TestRepository/STPSS/R_4/data/train/y_train.txt",open="r"))
